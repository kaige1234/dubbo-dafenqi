...
public class Token
{
	 ...
	 * ofKind is ID, simlpy add something like : <p/> case MyParserConstants.ID :
	 * return new IDToken(); <p/> to the following switch statement. Then you
	 * can cast matchedToken variable to the appropriate type and use it in your
	 * lexical actions.
	 */
