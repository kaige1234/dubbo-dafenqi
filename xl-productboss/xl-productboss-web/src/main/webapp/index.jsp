...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=37936523,1395323193&fm=27&gp=0.jpg" width="50" height="50"/></span>
                ...
                <li>
                    <a href="#"><i class="fa fa-table"></i>
                        <span class="nav-label">达分期</span><span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${ctx}/user/income/incomeActivity/list.do">活动管理</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="home.jsp?v=4.1.0" frameborder="0" data-id="home.jsp" seamless></iframe>
        </div>
        <div class="footer">
    ...
    <div class="small-chat-box fadeInRight animated">
        ...
        <div class="content">
            ...
            <div class="left">
                ...
                <div class="chat-message active">
                    1.所有源码(未压缩、带注释版本)； <br> 2.说明文档； <br> 3.终身免费升级服务； <br> 4.必要的技术支持； <br> 5.付费二次开发服务； <br> 6.授权许可； <br>
                    …… <br>
                </div>
            </div>
        </div>
