...
import com.xl.es.script.reflection.invoker.GetFieldInvoker;
import com.xl.es.script.reflection.invoker.Invoker;
import com.xl.es.script.reflection.invoker.MethodInvoker;
import com.xl.es.script.reflection.invoker.SetFieldInvoker;
import com.xl.es.script.reflection.property.PropertyNamer;
		...
		for (String propName : conflictingSetters.keySet()) {
			...
			if (setters.size() == 1) {
				...
				if (expectedType == null) {
					throw new ReflectionException("Illegal overloaded setter method with ambiguous type for property " + propName + " in class " + firstMethod.getDeclaringClass()
